...
def cats_and_toys_alike
  ...
  execute(<<-SQL)
    ...
    FROM 
      cats
    JOIN
      cattoys ON cats.id = cattoys.cat_id AND cats.color = 'Blue'
    JOIN
      toys ON toys.id = cattoys.toy_id AND toys.color = 'Blue'
    ORDER BY
      cats.name ASC
  SQL
end
...
def find_unknown
  ...
  execute(<<-SQL)
    ...
    FROM 
      cats
    JOIN
      cattoys ON cats.id = cattoys.cat_id AND cats.breed = 'Unknown'
    JOIN
      toys ON toys.id = cattoys.toy_id 
    ORDER BY
      toys.name
